...
public class TabWidgetImpl extends WidgetImpl implements Tab {

    private static final Logger LOG = LoggerFactory.getLogger(TabWidgetImpl.class);

    public TabWidgetImpl(String tabName, ComplexGUIElement container) {
