...
import com.example.core.gui.iface.simple.TextField;
...
public class TextFieldImpl extends SimpleGUIElementImpl implements TextField {

    private static final Logger LOG = LoggerFactory.getLogger(TextFieldImpl.class);

    public TextFieldImpl(String textFieldName, ComplexGUIElement container) {
