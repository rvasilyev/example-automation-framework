...
public abstract class SimpleGUIElementImpl extends GUIElementImpl implements SimpleGUIElement {

    private static final Logger LOG = LoggerFactory.getLogger(SimpleGUIElementImpl.class);

    protected SimpleGUIElementImpl(Locators locator, TypeNames typeName, String name, ComplexGUIElement container){
