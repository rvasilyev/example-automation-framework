...
import com.example.core.gui.iface.export.simple.Dropbox;
...
public class KKDropbox extends SimpleWebElement implements Dropbox {

    private static final Logger LOG = LoggerFactory.getLogger(KKDropbox.class);

    public KKDropbox(String dropboxName, ComplexGUIElement container) {
